    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-lg mx-auto">
                ...
                @endif
                <form id="imageUploadForm" class="mb-4" enctype="multipart/form-data" action="{{ route('upload.image.slider') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                    ...
                    @foreach($sliders as $slider)
                        <div class="w-1/3 px-4 mb-4">
                            <div class="relative" style="padding-top: 100%;">
                                <img src="{{ asset('uploads/'. $slider->image) }}" alt="Slider Image" class="absolute inset-0 w-full h-full object-cover rounded-md">
                            </div>
